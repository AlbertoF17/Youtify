...
function App() {
  ...
  function handleLogin(token) {
    try {
      ...
      // Comenzar a comprobar la URL actual de la ventana
      var intervalId = setInterval(function () {
        try {
          // Obtener la URL actual de la ventana
          var currentUrl = spotifyLoginWindow.location.href;
          if (spotifyLoginWindow.location.href === 'about:blank') {

          } else {
            if (currentUrl.includes(REDIRECT_URI)) {
